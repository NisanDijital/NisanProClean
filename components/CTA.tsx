  ...
  return (
    <section id="contact" className="py-24 px-4 relative scroll-mt-24">
      <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-surface-dark to-background-dark border border-white/10 rounded-3xl p-12 md:p-20 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-64 h-64 bg-primary/20 blur-[80px] rounded-full" />
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-secondary/20 blur-[80px] rounded-full" />

        <div className="relative z-10 flex flex-col items-center gap-6">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-2">Kusursuz Temizlige Hazir misiniz?</h2>
          <p className="text-gray-400 text-lg max-w-lg mb-6">
            NisanProClean guvencesiyle koltuklariniz icin en iyi bakimi bugun planlayin.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            ...
            >
              <span className="relative z-10">Randevunuzu Olusturun</span>
              <span className="material-symbols-outlined relative z-10">calendar_month</span>
              <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shine z-0" />
            </a>
            <a
          ...
          <p className="text-xs text-gray-500 mt-4">Analiz ucretsizdir. Gizli ucret yok.</p>
        </div>
      </div>
    </section>
  );
